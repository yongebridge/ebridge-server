        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMainChain = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "AppCrossChainIndexingInfos",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    BlockHeight = table.Column<long>(type: "bigint", nullable: false),
                    BlockTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IndexChainId = table.Column<int>(type: "int", nullable: false),
                    IndexBlockHeight = table.Column<long>(type: "bigint", nullable: false),
                    ChainId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCrossChainIndexingInfos", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "AppCrossChainTransfers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    TransferTokenId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ReceiveTokenId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Type = table.Column<int>(type: "int", nullable: false),
                    FromChainId = table.Column<int>(type: "int", nullable: false),
                    ToChainId = table.Column<int>(type: "int", nullable: false),
                    FromAddress = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ToAddress = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TransferTransactionId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceiveTransactionId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TransferTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TransferBlockHeight = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    ReceiveAmount = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ...
                    ProgressUpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCrossChainTransfers", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
