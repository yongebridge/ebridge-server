...
public class CommitmentRevealedProcessor : AElfEventProcessorBase<CommitmentRevealed>
{
    private readonly IOracleQueryInfoAppService _oracleQueryInfoAppService;
    private readonly IChainAppService _chainAppService;

    public CommitmentRevealedProcessor(IOracleQueryInfoAppService oracleQueryInfoAppService,
    ...
    protected override async Task HandleEventAsync(CommitmentRevealed eventDetailsEto, EventContext txInfoDto)
    {
