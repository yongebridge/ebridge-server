...
public class QueryCompletedWithoutAggregationProcessor : AElfEventProcessorBase<QueryCompletedWithoutAggregation>
{
    private readonly IOracleQueryInfoAppService _oracleQueryInfoAppService;
    private readonly IChainAppService _chainAppService;

    public QueryCompletedWithoutAggregationProcessor(IOracleQueryInfoAppService oracleQueryInfoAppService, IChainAppService chainAppService)
    {
        _oracleQueryInfoAppService = oracleQueryInfoAppService;
        _chainAppService = chainAppService;
    }

    protected override async Task HandleEventAsync(QueryCompletedWithoutAggregation eventDetailsEto, EventContext txInfoDto)
    {
